                                    ...
                                    <div aria-expanded="false" id="collapse_five" class="panel-collapse collapse" role="tabpanel" aria-labelledby="five">
                                        <div class="panel-body">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="customRadio1" name="payment_method" value="cod" class="custom-control-input" style="float-right">
                                                <label class="custom-control-label" for="customRadio1">Ok</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
