...
<!-- Quick View Modal Area -->
            ...
            <div class="row">
                    ...
                    <div class="single_product_thumb">
                        <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                @php
                                    $prdct_photo=explode(',',$prdct_dtls->photo);
                                @endphp
                                @foreach($prdct_photo as $key=>$pdphoto)
                                    <div class="carousel-item {{ $key==0 ? 'active' : '' }}">
                                        <a class="gallery_img" href="{{ $pdphoto }}" title="{{ $prdct_dtls->title }}">
                                            <img class="d-block w-100" src="{{ $pdphoto }}" alt="product details img">
                                        </a>
                                        <!-- Product Badge -->
                                        <div class="product_badge">
                                            <span class="badge-new">{{ $prdct_dtls->conditions }}</span>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                            ...
                            <ol class="carousel-indicators">
                                ...
                                @endphp
                                @foreach($prdct_photo as $key=>$pdphoto)
                                    <li class="{{$key==0 ? 'active' : ''}}" data-target="#product_details_slider" data-slide-to="{{$key}}" style="background-image: url({{ $pdphoto }});">
                                    </li>
                                @endforeach
                            </ol>
                        </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="single_product_desc">
                        <h4 class="title mb-2">{{ ucfirst($prdct_dtls->title) }}</h4>
                        ...
                        <h4 class="price mb-4">${{number_format($prdct_dtls->offer_price,2)}} <span>${{number_format($prdct_dtls->price,2)}}</span></h4>

                        <!-- Overview -->
                        <div class="short_overview mb-4">
                            <h6>Overview</h6>
                            <p>{{ $prdct_dtls->summary }}</p>
                        </div>
    ...
    <section class="you_may_like_area section_padding_0_100 clearfix">
        <div class="container">
            ...
            @if(count($prdct_dtls->relatedProductMR)>0)
            <div class="row">
                <div class="col-12">
                    <div class="you_make_like_slider owl-carousel">
                        <!-- Single Product -->
                        @foreach($prdct_dtls->relatedProductMR as $item)
                        <div class="single-product-area">
                            <div class="product_image">
                                <!-- Product Image -->
                                @php
                                    $photos=explode(',',$prdct_dtls->photo)
                                @endphp
                                <img class="normal_img" src="{{ $photos[0] }}" alt="related prodcut img">
                                {{-- <img class="hover_img" src="img/product-img/new-1.png" alt=""> --}}
                            ...
                            <div class="product_description">
                                ...
                                <h6 class="product-price">${{number_format($prdct_dtls->offer_price,2)}} <small><del class="text-danger">${{number_format($prdct_dtls->price,2)}}</small></h6>
                            </div>
                        </div>
                        @endforeach
                    </div>
