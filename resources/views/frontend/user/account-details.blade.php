                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="full_name" value="{{ $usr->full_name }}" id="firstName" placeholder="MD NAZRUL">
                                </div>
                            </div>
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    <label for="lastName">Username *</label>
                                    <input type="text" class="form-control" name="username" value="{{ $usr->username }}" id="lastName" placeholder="ISLAM">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" name="email" value="{{ $usr->email }}" id="emailAddress" placeholder="care.designingworld@gmail.com">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
